...
#
# - Build
# docker build --rm -t rhel6:reposync -f rhel6.x .
#
# - Run
# docker run -d --name="rhel6-reposync" -h "rhel6-reposync" -v /path/to/host/directory:/path/to/container/directory rhel6:reposync
#
# Use the base images
FROM ruo91/rhel:68
...
RUN subscription-manager register \
 --auto-attach --username="$RHNID" --password="$RHNPW" --name="docker_reposync" \
